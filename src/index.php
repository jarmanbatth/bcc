        ...
        <div class="panelContainer">
            ...
            <div class="panel" title="Home">
                <div class="wrapper">
                    ...
                    <h2>Welcome to our Business Card Portal!</h2>


                    <p class="em_text">Click on any template in which you want to create your business card. </p>                    
                    ...
                    <div class="section_w320 fl">
                        <img class="fl" src="images/portfolio.png" alt="portfolio" />
                        <div class="w320_content">
                            <h3>Iron Systems Template 1</h3>
                            <p>Create your card with mobile number.</p>
                            <div class="cleaner"></div>
                            <div class="button_01"><a href="/card.php/?template_id=1" class="cross-link">Create</a></div>
                        </div>
                    ...
                    <div class="section_w320 fr">
                        <img class="fl" src="images/aboutme.png" alt="portfolio" />
                        <div class="w320_content">
                            <h3>Iron Systems Template 2</h3>
                            <p>Create your card without mobile number.</p>
                            <div class="cleaner"></div>
                            <div class="button_01"><a href="/card.php/?template_id=2" class="cross-link">Create</a></div>
                        </div>
                    ...
                    <div class="section_w320 fl">
                        <img class="fl" src="images/portfolio.png" alt="portfolio" />
                        <div class="w320_content">
                            <h3>Iron Systems Template 3</h3>
                            <p>Create your card with mobile number.</p>
                            <div class="cleaner"></div>
                            <div class="button_01"><a href="/card.php/?template_id=3" class="cross-link">Create</a></div>
                        </div>
                    ...
                    <div class="section_w320 fr">
                        <img class="fl" src="images/aboutme.png" alt="portfolio" />
                        <div class="w320_content">
                            <h3>Iron Systems Template 4</h3>
                            <p>Create your card without mobile number.</p>
                            <div class="cleaner"></div>
                            <div class="button_01"><a href="/card.php/?template_id=4" class="cross-link">Create</a></div>
                        </div>
