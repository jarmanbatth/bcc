    ...
    ?>    
        ...
        foreach ($tableRows as $csv) {
            ...
            <tr style='color:#000;'>
                ...
                <td><?= $csv['email']; ?></td>
                <td><?php if($csv['status']==1){echo 'Active';}else { echo 'Inactive' ;} ; ?></td>
                <td> <div class='header'><?php echo "<a href='edit_user.php?q=" . $csv['id'] . "'>Edit</a>  |  <a href='delete_user.php?q=" . $csv['id'] . "'>Delete</a>" ?></td>
            </tr>
            <?php
            $count++;
        }
